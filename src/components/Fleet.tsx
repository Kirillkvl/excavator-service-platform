...
const MACHINES: Machine[] = [
  {
    ...
    group: "dig",
    spec: "Глубина копки до 5 м, ковш 0,8;0,6;0.4;0.3 м³",
    price: "2 900 ₽/час",
    icon: "Tractor",
  },
  {
    ...
    group: "dig",
    spec: "Масса 15–22 т, глубина до 6 м",
    price: "3 800 ₽/час",
    icon: "Shovel",
  },
  {
    ...
    group: "dig",
    spec: "Ковш 1,8–3 м³, вилы в комплекте",
    price: "2 700 ₽/час",
    icon: "Forklift",
  },
  {
    name: "Мини-погрузчик",
    group: "dig",
    spec: "Проезд в калитку, ковш и щётка",
    price: "2 700 ₽/час",
    icon: "Forklift",
  },
  {
    ...
    group: "dig",
    spec: "Отвал до 4 м, планировка и вскрыша",
    price: "4 000 ₽/час",
    icon: "Mountain",
  },
  {
    name: "Автогрейдер",
    group: "road",
    spec: "Профилирование дорог и площадок",
    price: "3 600 ₽/час",
    icon: "Ruler",
  },
  {
    ...
    group: "haul",
    spec: "Кузов 5–20 м³, разгрузка назад",
    price: "1 800 ₽/час",
    icon: "Truck",
  },
  {
    ...
    group: "haul",
    spec: "Перевозка длинных грузов до 20 т",
    price: "от 3 000 ₽/час",
    icon: "Container",
  },
  {
    ...
    group: "lift",
    spec: "Борт до 25 т, стрела 5–12 т",
    price: "1 800 ₽/час",
    icon: "Crane",
  },
  {
  ...
  },
  {
    ...
    group: "lift",
    spec: "Подача бетона на высоту до 57 м",
    price: "от 3 500 ₽/час",
    icon: "Container",
  },
];
...
const Fleet = () => {
  ...
  return (
    <section
      id="fleet"
      className="relative bg-primary py-20 text-primary-foreground md:py-28"
    >
      <div className="container">
        <div className="mb-10 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-background/70">
            12 видов машин: своя техника и проверенные партнёры. Нет нужной в
            парке — найдём и подгоним в тот же день.
          </p>
        </div>
