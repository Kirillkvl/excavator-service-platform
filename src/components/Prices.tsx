...
const ROWS = [
  { name: 'Экскаватор-погрузчик', hour: '2 900 ₽', shift: '23 200 ₽', min: '4 часа' },
  { name: 'Колёсный экскаватор', hour: '3 800 ₽', shift: '30 400 ₽', min: '4 часа' },
  { name: 'Фронтальный погрузчик', hour: '2 700 ₽', shift: '21 600 ₽', min: '4 часа' },
  { name: 'Мини-погрузчик', hour: '2 700 ₽', shift: '21 600 ₽', min: '4 часа' },
  { name: 'Автогрейдер', hour: '3 600 ₽', shift: '28 800 ₽', min: '4 часа' },
  { name: 'Бульдозер 17–51 т', hour: '4 000 ₽', shift: '32 000 ₽', min: '4 часа' },
  { name: 'Автокран 12–75 т', hour: '2 500 ₽', shift: '20 000 ₽', min: '4 часа' },
  { name: 'Самосвал 5–35 т', hour: '1 800 ₽', shift: '14 400 ₽', min: '4 часа' },
  { name: 'Манипулятор 5–25 т', hour: '1 800 ₽', shift: '14 400 ₽', min: '4 часа' },
  { name: 'Автовышка 10–55 м', hour: '1 700 ₽', shift: '13 600 ₽', min: '4 часа' },
  { name: 'Автобетононасос 18–57 м', hour: 'от 3 500 ₽', shift: 'от 28 000 ₽', min: '4 часа' },
  { name: 'Длинномеры 12–13,6 м', hour: 'от 3 000 ₽', shift: 'от 24 000 ₽', min: '4 часа' },
];
        ...
        <div className="grid gap-12 lg:grid-cols-[1.15fr_1fr]">
          <div className="border-4 border-foreground bg-card">
            ...
            <div className="flex items-start gap-2 bg-muted px-4 py-4 text-[11px] leading-relaxed text-muted-foreground sm:px-6">
              ...
              Оплата почасовая, минимальный заказ — 4 часа. Цены ориентировочные: точную ставку
              называем после уточнения объёма, грунта и удалённости объекта.
            </div>
          </div>
