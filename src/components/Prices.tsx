...
const ROWS = [
  { name: 'Мини-экскаватор', hour: '1 300 ₽', shift: '9 500 ₽', min: '4 часа' },
  { name: 'Экскаватор-погрузчик', hour: '1 600 ₽', shift: '11 000 ₽', min: '4 часа' },
  { name: 'Гусеничный экскаватор', hour: '2 400 ₽', shift: '17 500 ₽', min: '8 часов' },
  { name: 'Самосвал 10 т', hour: '1 400 ₽', shift: '10 000 ₽', min: '4 часа' },
  { name: 'Самосвал 20–30 т', hour: '2 200 ₽', shift: '16 000 ₽', min: '8 часов' },
  { name: 'Манипулятор', hour: '1 900 ₽', shift: '13 500 ₽', min: '4 часа' },
  { name: 'Автокран 25 т', hour: '2 500 ₽', shift: '18 000 ₽', min: '5 часов' },
  { name: 'Ямобур', hour: '1 800 ₽', shift: '12 500 ₽', min: '4 часа' },
  { name: 'Бульдозер', hour: '2 600 ₽', shift: '19 000 ₽', min: '8 часов' },
];
...
const TERMS = [
  ...
  },
  {
    ...
    a: 'Минимальный заказ — 4 часа для лёгкой техники и 8 часов для тяжёлой. Каждый час сверх смены считается по часовой ставке без повышающего коэффициента.',
  },
  {
    q: 'Оплата',
