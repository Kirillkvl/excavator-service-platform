...
const TERMS = [
  {
    ...
    a: "Отсчёт идёт с момента прибытия машины на объект и до окончания работ. Подача по городу + 1 час работ, за область — по километражу, 20 км в обе стороны час подачи.",
  },
  {
    q: "Минимальный заказ и переработка",
    a: "Оплата почасовая, минимальный заказ — от 4 часов на любую технику. Дальше считаем по факту: каждый час сверх минимума по часовой ставке без повышающего коэффициента, от 8 часов выгоднее взять смену.",
  },
  {
    q: "Оплата",
